...
extension UITabBarController {
    enum Tabs {
        ...
        var className: String {
            ...
            case .activities:
                return String(describing: AccountsViewController.self)
            case .settings:
        ...
        var tabBarItem: UITabBarItem {
            switch self {
            case .tokens:
                return UITabBarItem(title: R.string.localizable.walletTokensTabbarItemTitle(), image: R.image.tab_home(), selectedImage: nil)
            case .settings:
                return UITabBarItem(title: R.string.localizable.aSettingsNavigationTitle(), image: R.image.tab_settings(), selectedImage: nil)
            case .transactions:
                return UITabBarItem(title: R.string.localizable.transactionsTabbarItemTitle(), image: R.image.tab_wallet(), selectedImage: nil)
            case .activities:
                return UITabBarItem(title: R.string.localizable.activityTabbarItemTitle(), image: R.image.tab_wallet(), selectedImage: nil)
            case .browser:
